...
apollo_beta = c(
  ...
  b_wq_change_x_bl_0_1 = 0,
  b_wq_change_x_bl_1_2 = 0,
  b_wq_change_x_bl_2_3 = 0
...
apollo_probabilities = function(apollo_beta, apollo_inputs, functionality = "estimate") {
  ...
  V[["policy"]] = b_asc + 
    ...
    b_wq_change_x_bl_0_1 * WQ_CHANGE * BASELINE_WQ_0_1UNIT  +
    b_wq_change_x_bl_1_2 * WQ_CHANGE * BASELINE_WQ_1_2UNIT  +
    b_wq_change_x_bl_2_3 * WQ_CHANGE * BASELINE_WQ_2_3UNIT 
